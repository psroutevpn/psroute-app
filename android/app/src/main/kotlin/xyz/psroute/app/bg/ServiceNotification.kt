...
import xyz.psroute.app.Application
import xyz.psroute.app.MainActivity
import xyz.psroute.app.R
import xyz.psroute.app.Settings
import xyz.psroute.app.constant.Action
import xyz.psroute.app.constant.Status
//import xyz.psroute.app.utils.CommandClient
import com.hiddify.core.libbox.Libbox
import xyz.psroute.app.Application.Companion.notification
import xyz.psroute.app.utils.GrpcClientProvider
    ...
    fun show(profileName: String, @StringRes contentTextId: Int) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Application.notification.createNotificationChannel(
                NotificationChannel(
                    notificationChannel, "PS Route service", NotificationManager.IMPORTANCE_LOW
                )
            )
        }
        service.startForeground(
            notificationId, notificationBuilder
                .setContentTitle(profileName.takeIf { it.isNotBlank() } ?: "PS Route")
